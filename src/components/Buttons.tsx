...
export default function Buttons ({
  ...
  const handleClick = (event: React.MouseEvent): void => {
    ...
    const $carouselToRead = document.querySelector(
      '.content-section-to-read .carousel'
    ) as HTMLDivElement
    ...
    if (target.matches('.content-section .btn-left *')) {
      ...
      $carousel.style.transform = `translateX(-${
        $carousel.clientWidth - $carouselContainer.clientWidth
      }px)`
    }
    ...
    if (target.matches('.content-section-to-read .btn-left *')) {
      ...
      $carouselToRead.style.transform = `translateX(-${
        $carouselToRead.clientWidth - $carouselContainer.clientWidth
      }px)`
    }
  }
